...
export type NavigationClientLink = {
  id: string;
  label: string;
  href: string;
  activePath?: string;
...
type NavigationClientProps = {
  ...
  enquireButtonHref: string;
  navItems: NavigationClientLink[];
};

function LogoImage({ logoSrc, siteName }: { logoSrc: string; siteName: string }) {
